...
require_once(dirname(__FILE__).'/Harmoni_DOMDocument.class.php');
...
class XmlPrinter {
	...
	public function __construct () {
		...
		$this->doc->appendChild($this->doc->createElementNS('https://login.middlebury.edu/directory/', 'directory:results'));
	}
	...
	protected function addEntry (LdapUser $userOrGroup) {
		$elem = $this->doc->documentElement->appendChild($this->doc->createElementNS('https://login.middlebury.edu/directory', 'directory:entry'));
